...
def surgical_arrange_Xiao(pList, attending, aName):
...
def surgical_arrange_Hu(pList, attending, aName):
    ...
    if weekday == 1:
        prelastSurgeryDate = today + rd.relativedelta(weekday=rd.WE(-1))
        lastSurgeryDate = today + rd.relativedelta(weekday=rd.MO(-1))
        upcomingSurgeryDate = today + rd.relativedelta(weekday=rd.WE)
        nextSurgeyDate = today + rd.relativedelta(weekday=rd.MO)
    elif weekday == 2:
        prelastSurgeryDate = today + rd.relativedelta(weekday=rd.WE(-2))
        lastSurgeryDate = today + rd.relativedelta(weekday=rd.MO(-1))
        upcomingSurgeryDate = today + rd.relativedelta(weekday=rd.MO)
        nextSurgeyDate = today + rd.relativedelta(weekday=rd.WE(2))
    elif weekday == 0:
        prelastSurgeryDate = today + rd.relativedelta(weekday=rd.MO(-2))
        lastSurgeryDate = today + rd.relativedelta(weekday=rd.WE(-1))
        upcomingSurgeryDate = today + rd.relativedelta(weekday=rd.WE)
        nextSurgeyDate = today + rd.relativedelta(weekday=rd.MO)
    else:
        prelastSurgeryDate = today + rd.relativedelta(weekday=rd.MO(-1))
        lastSurgeryDate = today + rd.relativedelta(weekday=rd.WE(-1))
        upcomingSurgeryDate = today + rd.relativedelta(weekday=rd.MO)
        nextSurgeyDate = today + rd.relativedelta(weekday=rd.WE)
...
def surgical_arrange_Jiang(pList, attending, aName):
    ...
    if weekday == 0:
        prelastSurgeryDate = today + rd.relativedelta(weekday=rd.MO(-3))
        lastSurgeryDate = today + rd.relativedelta(weekday=rd.MO(-2))
        upcomingSurgeryDate = today + rd.relativedelta(weekday=rd.MO(2))
        nextSurgeyDate = today + rd.relativedelta(weekday=rd.MO(3))
    # elif weekday == 2:
    #     lastSurgeryDate = today + rd.relativedelta(weekday=rd.MO(-1))
    #     prelastSurgeryDate = today + rd.relativedelta(weekday=rd.WE(-2))
    #     upcomingSurgeryDate = today + rd.relativedelta(weekday=rd.MO)
    ...
    #     nextSurgeyDate = today + rd.relativedelta(weekday=rd.MO)
        ...
        lastSurgeryDate = today + rd.relativedelta(weekday=rd.MO(-1))
        upcomingSurgeryDate = today + rd.relativedelta(weekday=rd.MO)
        nextSurgeyDate = today + rd.relativedelta(weekday=rd.MO(2))
    ...
    # 删除 schdeuleList 里 dohoscode为 钱塘院区 的行
    scheduleList = scheduleList[scheduleList['dohoscode'] != '钱塘院区']
    scheduleList = scheduleList[scheduleList['dohoscode'] != '大运河院区']
...
def surgical_arrange_Zhang(pList, attending, aName):
