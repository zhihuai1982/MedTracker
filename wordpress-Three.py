...
tpListRaw = requests.request(
    "GET",
    "https://api.trello.com/1/boards/674b131852f1aa06d43cdce6/lists",
...
hpListRaw = requests.get(
    'http://20.21.1.224:5537/api/api/Bed/GetPatientList/%E5%8C%BB%E7%96%97%E7%BB%84/30044/33/A001', headers=headers).json()
...
pContent += trello_note("674b24630150b40c2e20e0d7", "other")
pContent += f"""
        <form class="myForm">
        <input type="hidden" class="list_id" value="674b24630150b40c2e20e0d7">
...
arrangeList, arrangeListHtml, upcomingSurgeryDate_str = surgical_arrange_Hu(
    pList, 30044, "胡孙宏")
...
tpListRaw = requests.request(
    "GET",
    "https://api.trello.com/1/boards/674b18a9aad2bf78ee8946d3/lists",
    headers=trelloheaders,
    params=query,
    verify=False,
).json()
...
hpListRaw = requests.get(
    'http://20.21.1.224:5537/api/api/Bed/GetPatientList/%E5%8C%BB%E7%96%97%E7%BB%84/30346/33/A001', headers=headers).json()
...
pContent += "<!-- wp:heading {'level':1} -->\n<div id='xiao-notes'><h1 class='wp-block-heading'>姜组备注</h1></div>\n<!-- /wp:heading -->\n"
...
pContent += "<!-- wp:heading -->\n<h4 class='wp-block-heading'>其他备注</h4>\n<!-- /wp:heading -->\n"
pContent += trello_note("674b28840a74550e520f8c31", "other")
pContent += f"""
        <form class="myForm">
        <input type="hidden" class="list_id" value="674b28840a74550e520f8c31">
        <input type="text" class="name" name="name", style="width: 100%; height: 70px; margin-bottom: 10px;"><br>
        <input type="submit" value="Submit" style="  display: block; margin-left: auto;">
        </form>
        <p class="message"></p>\n
...
arrangeList, arrangeListHtml, upcomingSurgeryDate_str = surgical_arrange_Jiang(
    pList, 30346, "姜秀文")
...
tpListRaw = requests.request(
    "GET",
    "https://api.trello.com/1/boards/674b18d98d4008ded14a6c38/lists",
    headers=trelloheaders,
    params=query,
    verify=False,
).json()
...
if len(tpList) > 0:
    ...
    #  住院系统获取患者列表
    hpListRaw = requests.get(
        'http://20.21.1.224:5537/api/api/Bed/GetPatientList/%E5%8C%BB%E7%96%97%E7%BB%84/30594/33/A001', headers=headers).json()
    ...
    pContent += "<!-- wp:heading {'level':1} -->\n<div id='xiao-notes'><h1 class='wp-block-heading'>张组备注</h1></div>\n<!-- /wp:heading -->\n"
    ...
    pContent += "<!-- wp:heading -->\n<h4 class='wp-block-heading'>其他备注</h4>\n<!-- /wp:heading -->\n"
    pContent += trello_note("674b293101c762b3976af116", "other")
    pContent += f"""
            <form class="myForm">
            <input type="hidden" class="list_id" value="674b293101c762b3976af116">
            <input type="text" class="name" name="name", style="width: 100%; height: 70px; margin-bottom: 10px;"><br>
            <input type="submit" value="Submit" style="  display: block; margin-left: auto;">
            </form>
            <p class="message"></p>\n
    ...
    arrangeList, arrangeListHtml, upcomingSurgeryDate_str = surgical_arrange_Zhang(
        pList, 30594, "张守德")
